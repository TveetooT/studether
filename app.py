...
Phrases = {
    ...
    "RulesMessage": (
        ...
        "1️⃣ Анкету видят другие пользователи из твоего города — указывай только то, что готов(а) показать незнакомым людям.\n"
        "2️⃣ Никаких оскорблений, разжигания розни, спама и мошенничества — анкету за это заблокируют.\n"
        "3️⃣ Не выдавай себя за другого человека и не указывай чужие персональные данные.\n"
        "4️⃣ Жалобы («⚠️ Пожаловаться») — только по делу; злоупотребление этой кнопкой тоже не приветствуется.\n\n"
